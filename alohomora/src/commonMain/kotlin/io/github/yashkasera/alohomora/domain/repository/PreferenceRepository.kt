...
internal interface PreferenceRepository {
     ...
     */
    fun observeAllPreferences(): Flow<List<PreferenceEntry>>
     ...
     */
    suspend fun refresh(): List<PreferenceEntry>
     ...
     */
    suspend fun getStores(): List<PreferenceStore>
     ...
     */
    fun getTotalSize(entries: List<PreferenceEntry>): String
}
