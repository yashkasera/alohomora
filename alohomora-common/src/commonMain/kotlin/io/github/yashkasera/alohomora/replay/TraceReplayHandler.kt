 ...
 *
 * Deliberately not a `TraceEntry`. A trace is a *record* of what happened and is not safe to
...
/** The result of handing a [ReplayRequest] to a [TraceReplayHandler]. */
 ...
 * ```
 */
fun interface TraceReplayHandler {
