...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "AlohomoraKit",
            url: "https://github.com/yashkasera/Alohomora/releases/download/v1.1.0/AlohomoraKit.xcframework.zip",
            checksum: "ba50699161a472f7afc8aad75349a6dc59083e4be09083b66243421d373c97de"
        ),
    ]
)
